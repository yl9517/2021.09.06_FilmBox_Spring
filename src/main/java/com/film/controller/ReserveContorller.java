...
public class ReserveContorller {
	...
	public String kakaojsp(KakaopayDTO dto, @RequestParam int ousepoint, Model model, HttpSession session)throws IOException {
		...
		if (member_id == null) {
	    	...
	    	model.addAttribute("code",prop.getProperty("kakaoCode"));
			model.addAttribute("dto", dto);
